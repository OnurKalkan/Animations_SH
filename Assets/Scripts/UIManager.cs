...
public class UIManager : MonoBehaviour
{
    ...
    public int timer = 100, roundNo = 1;
    ...
    void Start()
    {
        ...
        playerOne.GetComponent<Warrior>().enabled = false;
        playerTwo.GetComponent<Warrior>().enabled = false;
    ...
    IEnumerator Timer()
    {
        playerOne.GetComponent<Warrior>().enabled = true;
        playerTwo.GetComponent<Warrior>().enabled = true;
        yield return new WaitForSeconds(1);
        timer--;
        //timer -= 1;
        //timer = timer - 1;
    ...
    IEnumerator RoundWinnerCheck()
    {
        ...
        if(playerOne.GetComponent<Warrior>().health > playerTwo.GetComponent<Warrior>().health)
        {
            roundEndText.text = "Player One Wins";
        }
        else if (playerOne.GetComponent<Warrior>().health == playerTwo.GetComponent<Warrior>().health)
        {
